...
class UserFriendshipsControllerTest < ActionController::TestCase
	...
	context "#accept" do
		...
		context "when logged in" do
			setup do
				@friend = create(:user)
				@user_friendship = create(:pending_user_friendship, user: users(:jack), friend: @friend)
				create(:pending_user_friendship, friend: users(:jack), user: @friend)
				sign_in users(:jack)
		...
		context "when logged in" do
			setup do
				@friend = create(:user)
				@user_friendship = create(:accepted_user_friendship, friend: @friend, user: users(:jack))
				create(:accepted_user_friendship, friend: users(:jack), user: @friend)
